...
describe('Service Tests', () => {
  describe('Ruolo Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(RuoloService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Ruolo(0, currentDate, currentDate, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Ruolo', () => {
        ...
        service.create(new Ruolo()).subscribe(resp => (expectedResult = resp.body));
