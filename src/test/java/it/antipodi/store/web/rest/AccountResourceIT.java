...
import static it.antipodi.store.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import it.antipodi.store.AntipodiStoreApp;
import it.antipodi.store.config.Constants;
import it.antipodi.store.domain.User;
import it.antipodi.store.repository.AuthorityRepository;
import it.antipodi.store.repository.UserRepository;
import it.antipodi.store.security.AuthoritiesConstants;
import it.antipodi.store.service.UserService;
import it.antipodi.store.service.dto.PasswordChangeDTO;
import it.antipodi.store.service.dto.UserDTO;
import it.antipodi.store.web.rest.vm.KeyAndPasswordVM;
import it.antipodi.store.web.rest.vm.ManagedUserVM;
