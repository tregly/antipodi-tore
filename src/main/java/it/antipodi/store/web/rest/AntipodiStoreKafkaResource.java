...
@RestController
@RequestMapping("/api/antipodi-store-kafka")
public class AntipodiStoreKafkaResource {
    private final Logger log = LoggerFactory.getLogger(AntipodiStoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AntipodiStoreKafkaResource(KafkaProperties kafkaProperties) {
